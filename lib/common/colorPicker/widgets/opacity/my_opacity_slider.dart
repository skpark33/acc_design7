...
ThemeData _sliderTheme(Color color, List<Color> colors) =>
    ThemeData.light().copyWith(
      sliderTheme: SliderThemeData(
        ...
        trackShape: MyOpacitySliderTrack(color, colors),
      ),
    );

class MyOpacitySlider extends StatelessWidget {
...
class MyOpacitySliderTrack extends SliderTrackShape with BaseSliderTrackShape {
  final Color selectedColor;
  final List<Color> colors;

  const MyOpacitySliderTrack(this.selectedColor, this.colors);
