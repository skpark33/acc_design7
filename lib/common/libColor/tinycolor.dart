...
class TinyColor {
  ...
  TinyColor complement() {
    if (_color! == Color(0xFFFFFFFF)) {
      return TinyColor(Color(0xFF000000));
    }
    if (_color! == Color(0xFF3A3B41)) {
      return TinyColor(Color(0xFFE0E0E0));
    }
    if (_color! == Color(0xFF000000)) {
      return TinyColor(Color(0xFFFFFFFF));
    }
    final hsl = toHsl();
    hsl.h = (hsl.h + 180) % 360;
    return TinyColor.fromHSL(hsl);
