      ...
      children: [
          ...
          child: Row(
            ...
            children: [
              Container(
                ...
                child: myTextField(
                  widget.selectedPage!.description.value.isEmpty
                      ? '${MyStrings.title} ${widget.selectedPage!.id + 1}'
                      : widget.selectedPage!.description.value,
                  limit: 24,
        ...
        Padding(
          ...
          child: ToggleSwitch(
            minHeight: 30.0,
            minWidth: 90.0,
            initialLabelIndex: widget.selectedPage!.width.value <
                    widget.selectedPage!.height.value
                ? 1
                : 0,
            cornerRadius: 20.0,
            radiusStyle: true,
            ...
            onToggle: (index) {
              ...
              if (index == 0) // 가로
              {
                if (widget.selectedPage!.width.value <
                    widget.selectedPage!.height.value) {
                  _swapRatio(true);
                }
              } else if (index == 1) {
        ...
        Padding(
          ...
          child: ToggleSwitch(
            ...
            onToggle: (index) {
              ...
              switch (index) {
                case 0:
                  widget.selectedPage!.width
                      .set(widget.isLandscape ? 1280 : 720);
                  widget.selectedPage!.height
                      .set(widget.isLandscape ? 720 : 1280);
                  isSizeChangable = false;
                  break;
                case 1:
                  widget.selectedPage!.width
                      .set(widget.isLandscape ? 1920 : 1080);
                  widget.selectedPage!.height
                      .set(widget.isLandscape ? 1080 : 1920);
                  isSizeChangable = false;
                  break;
                case 2:
                  widget.selectedPage!.width
                      .set(widget.isLandscape ? 2560 : 1440);
                  widget.selectedPage!.height
                      .set(widget.isLandscape ? 1440 : 2560);
                  isSizeChangable = false;
                  break;
                case 3:
                  widget.selectedPage!.width
                      .set(widget.isLandscape ? 3840 : 2160);
                  widget.selectedPage!.height
                      .set(widget.isLandscape ? 2160 : 3840);
                  isSizeChangable = false;
                  break;
                default:
                  widget.selectedPage!.width
                      .set(widget.isLandscape ? 1921 : 1081);
                  widget.selectedPage!.height
                      .set(widget.isLandscape ? 1081 : 1921);
      ...
      return CircleAvatar(
          ...
          child: IconButton(
            ...
            onPressed: () {
              ...
              widget.selectedPage!.bgColor.set(bg);
              logHolder.log(
                  'color=${widget.selectedPage!.bgColor.value.toString()}');
              logHolder.log(
                  'color=${widget.selectedPage!.bgColor.value.toString().substring(8, 16)}');
              //});
              pageManagerHolder!.setState();
            },
          ));
